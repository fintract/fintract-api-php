...
/**
 * Upload a CRE - DE document. Accepted formats: jpeg, png and tiff
...
$path = __DIR__.'/files/commercialRegisterExtract.pdf';
...
try
{
	$response =  $fintractApi->commercialRegisterExtractDE($dataString);
	print_r($response);
}
